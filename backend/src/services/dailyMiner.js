...
const TARGETS = [
    ...
    { source: "mango", url: "https://shop.mango.com/tr/tr/kadin", gender: "woman" }, // Generic Fallback (Link fix)
    ...
    { source: "beymenclub", url: "https://www.beymenclub.com/kadin", gender: "woman" }, // Link Fix
    { source: "vakko", url: "https://www.vakko.com/kadin", gender: "woman" }, // Link Fix
    ...
    { source: "lesbenjamins", url: "https://lesbenjamins.com/collections/new-arrivals", gender: "unisex" } // Link Fix];
